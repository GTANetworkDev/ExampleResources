function setHandCards(firstCard: string, secondCard: string): void {
...
function addTableCard(card:string, selected: boolean = false):void {
...
function addTimerText(label: string, text: string, selected: boolean = false):void {
    let newli = document.createElement("li");
    let tableul = document.getElementById("timerbarsList");
...
function addTimerCards(label: string, cardLeft: string, cardRight: string): void {
